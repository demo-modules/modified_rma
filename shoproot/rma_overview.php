...
// Modul aktivieren	
if (MODULE_MODIFIED_RMA_STATUS == 'true'){

if(isset($_SESSION['customer_id'])){
	$smarty->assign('language', $_SESSION['language']);
	$orders_query = xtc_db_query("select
	  orders_id, DATE_FORMAT(date_purchased , '%d.%m.%Y') AS DATE
	  from ".TABLE_ORDERS." 
...
// RMA OVERVIEW	
	...
	$rma_query = xtc_db_query("SELECT rma_id, rma_date, rma_status_id 
		FROM ".TABLE_RMA." WHERE customers_id = '".(int)$_SESSION['customer_id']."' ORDER BY rma_id DESC");
