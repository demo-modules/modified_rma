...
defined('FILENAME_RMA_OVERVIEW') or define('FILENAME_RMA_OVERVIEW','rma_overview.php');
defined('FILENAME_RMA_REQUEST') or define('FILENAME_RMA_REQUEST','rma_request.php');
